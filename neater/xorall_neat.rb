...
#= DEBUGGING FOR RubyNEAT using all Neurons
...
define "XOR All CPPN Debug System" do
  ...
  # of unique flag.
  hidden gau: GaussianNeuron, sin: SineNeuron, lin: LinearNeuron, tan: TanhNeuron
  ...
  # Mating
  survival_threshold            0.10 # top % allowed to mate in a species.
  survival_mininum_per_species  4 # for small populations, we need SOMETHING to go on.

  # Fitness costs
  fitness_cost_per_neuron 0.000000
  fitness_cost_per_gene   0.000000
